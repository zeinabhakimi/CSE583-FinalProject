...
I used kitti dataset for my training. You can download the dataset from http://www.cvlibs.net/download.php?file=data_object_image_2.zipand run following code to split the data into train/val
